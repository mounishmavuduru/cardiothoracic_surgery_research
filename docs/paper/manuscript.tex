...
is in fact the set of caps over the four pulmonary veins and the mitral valve
(five components, each a topological disc; zero adjacency to fibrotic elements;
removing them leaves Euler characteristic $-3$, i.e.\ exactly five openings), so
activation could cross those orifices instead of circling them. Repairing both
