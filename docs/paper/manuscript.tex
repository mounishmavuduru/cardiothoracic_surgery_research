...
\title{\textbf{AtrialSpectralBench}: where a spectral fragility biomarker stops
being measurable, and why finer meshes push real atria further past that
boundary\\[4pt]
\large A pre-registered null across $182$ patients and $10^{5}$ networks; a
label-free validity radius placing real tissue some $10^{3}\times$ beyond it; a
spectral gap that collapses at the Weyl exponent; and a false positive this
protocol withdrew from our own results}
...
audit that found it, and the four controls that located the real cause, are
reported in full. Where the
