...
UW/Boyle $n=82$) the result is \textbf{underpowered and inconclusive, not a clean
...
null \emph{is} clean, in the synthetic cohort, the mechanism is \textbf{feature
...
$\rhoval^\ast\approx 3$), so by Davis--Kahan the Fiedler vector is unstable. We do \textbf{not} claim $\rhoval$ proves non-predictiveness; it bounds the
...
criterion, a scaling characterization, and a demonstration of the false
positives that standard methodology produces.
\end{abstract}
